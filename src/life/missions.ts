...
export function createFirstDayMission(): Mission {
  return {
    ...
    category: 'main',
    description: 'Explore home, step into the neighborhood, meet someone, and open your phone.',
    objectives: [
      { id: 'explore-home', label: 'Explore your home', done: false },
      { id: 'leave-home', label: 'Leave the house', done: false },
      { id: 'explore-neighborhood', label: 'Explore the neighborhood', done: false },
      { id: 'meet-someone', label: 'Meet someone new', done: false },
      { id: 'open-phone', label: 'Open your phone', done: false },
      { id: 'first-opportunity', label: 'Discover a first opportunity', done: false },
    ],
    rewardXp: 120,
    rewardCash: 25,
...
export function createPersonalizedOpportunity(goals: LifeGoalId[]): Mission {
  ...
  return {
    ...
    objectives: [
      ...
      { id: 'first-paycheck', label: 'Receive your first paycheck', done: false },
